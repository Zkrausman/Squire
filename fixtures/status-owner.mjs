...
try {
  ...
  if (stage === 'abandon-published') await states.failReserved({ ...state, version: 2, status: 'failed', lifecycle: 'failed', launchState: 'failed', preparationState: 'failed', endedAt: state.updatedAt, lastError: 'fixture abandonment', terminalReason: 'fixture abandonment' });
  await barrier;
