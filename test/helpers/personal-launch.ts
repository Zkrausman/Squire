...
export const TEST_CONFIG_DIGEST = createHash("sha256").update("{}").digest("hex");
export const TEST_MATERIAL = await captureLaunchMaterial({
  rawConfig: Buffer.from("{}").toString("base64"), digest: TEST_CONFIG_DIGEST,
  config: {
