...
export const runtime: RuntimeResolution = { schemaVersion: 1, runId: "run_example01", pi: { version: "observed-pi", executable: "/ticket/runtime/pi", installationId: "pi-install-A" }, llmWiki: { version: "observed-wiki", installationId: "wiki-install-A" }, resolvedAt: "2026-09-01T12:00:00Z" };
