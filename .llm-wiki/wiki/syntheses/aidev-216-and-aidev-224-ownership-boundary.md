...
updated: 2026-09-01
confidence: high
sources: [sources/SRC-2026-09-01-001, sources/SRC-2026-09-01-002, sources/SRC-2026-09-01-009, sources/SRC-2026-09-01-010]
---
...
This split was the architecture review's only initial ownership concern and was accepted after correction. [Independent review](/sources/SRC-2026-09-01-002.md) AIDEV-216 therefore must not ship SQL, migrations, a production in-memory fallback, Linear intake, or reconciliation. It defines persisted process-allocation states and exact-token in-process compensation after observed process exit. A terminated first-session spawn becomes explicit `failed` state rather than authorizing another session; AIDEV-224's later startup reconciliation adapter determines the durable recovery outcome without weakening the [allocation fencing requirement](/sources/SRC-2026-09-01-009.md) or [settlement cleanup requirement](/sources/SRC-2026-09-01-010.md). The boundary should be preserved through [epic wiki maintenance](/analyses/epic-boundary-project-wiki-maintenance.md).
