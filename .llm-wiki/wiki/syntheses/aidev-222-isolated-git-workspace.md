...
Implementation is in `src/git/`; architecture details are in `docs/aidev-222-git-workspace.md`. Evidence: [[sources/obs-2026-09-03-aidev-222-git-workspace-implementation-completed]], [[sources/aidev-222-hardened-git-workspace-remediation]], [[sources/aidev-222-review-2-remediation-complete]], and [[sources/aidev-222-isolated-git-workspace]].
