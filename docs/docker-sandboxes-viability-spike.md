...
- Host bridge directory: `C:\Users\zkrau\AppData\Local\Temp\squire-sbx-aidev-214-bridge`
...
- The host Squire checkout at `E:\Repos - Non Indexed\squire` was not visible.
...
Host-side command output is retained under:
`C:\Users\zkrau\AppData\Local\Temp\squire-sbx-aidev-214-bridge\concurrent`
...
- Controller verification is retained at:
  `C:\Users\zkrau\AppData\Local\Temp\squire-aidev-214-export-verify\controller-verification.json`
