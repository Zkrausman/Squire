...
assert.deepEqual(windowsLaunchJob, {
  ...
  steps: [
    ...
    { name: "Run Windows launch capture regression", "timeout-minutes": "5", run: "node --test --test-timeout=120000 dist/test/personal-windows-status.test.js dist/test/personal-reservation-observation.test.js dist/test/personal-windows-state-replace.test.js dist/test/personal-windows-launch.test.js dist/test/personal-launch-material.test.js dist/test/personal-background-status.test.js dist/test/personal-controller.test.js dist/test/personal-plan-supervisor.test.js" },
  ],
