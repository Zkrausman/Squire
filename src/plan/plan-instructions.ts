import { PLAN_ALLOWED_BUILTIN_TOOLS, PLAN_ALLOWED_WIKI_TOOLS, PLAN_TOOL_NAME } from "./domain.js";
...
export const PLAN_SYSTEM_PROMPT = [
  ...
  "You may inspect repository files and the project-only wiki using the explicitly available read/search tools.",
  ...
  `The controller's fixed Plan allowlist is: ${[...PLAN_ALLOWED_BUILTIN_TOOLS, ...PLAN_ALLOWED_WIKI_TOOLS, PLAN_TOOL_NAME].join(", ")}.`,
