...
export class SbxV039Driver implements SandboxDriver {
  ...
  async execWorker(expected: SbxObservedSandbox, signal?: AbortSignal): Promise<SbxExecHandle> {
    ...
    if (!child || typeof child !== "object" || typeof child.identity !== "string" || typeof child.kill !== "function" || typeof child.pid !== "number" || typeof child.startTime !== "string") throw new SandboxContractError("trusted guest worker did not return a durable process handle");
