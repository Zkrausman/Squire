...
function buildPrompt(phase: PersonalPhase, inputPath: string, testCommands: readonly string[]): string {
  ...
  return [
    ...
    '{"runId":"...","phase":"plan|implement|review|test","attempt":1,"sessionId":"...","sessionFile":"...","inputHead":"40-hex","outputHead":"40-hex","status":"passed|remediation_required|failed","summary":"...","details":{}}',
